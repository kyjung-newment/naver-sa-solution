...
const DEFAULT_SETTINGS = {
  ...
  // 기본값은 빈 값 — 브랜드별 목록은 계정 설정(bid_settings)에 저장 (이고진 초기 4건은 마이그레이션으로 이관됨)
  excluded_campaigns: '',
  // 구글 시트 연동 (목표ROAS·운영등급 — 1행 헤더 '소재ID'/'손익분기 ROAS'/'운영등급' 기준 매칭)
  sheet_sync_url: '',  // 스프레드시트 주소 (링크 공유 '보기' 필요)
  sheet_sync_at: '',   // 최근 반영 일시 (성공 시 기록)
};
