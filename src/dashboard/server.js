...
router.get('/reports', requireLogin, requireApi, async (req, res) => {
  ...
  const content = `
    ...
    var FIELD_DEFS = [
      ...
      {cat:'전환 성과', key:'convCnt', label:'총 전환수', type:'metric', sup:true},
      {cat:'전환 성과', key:'convDirectCnt', label:'직접전환수', type:'metric', sup:true},
      {cat:'전환 성과', key:'convIndirectCnt', label:'간접전환수', type:'metric', sup:true},
      {cat:'전환 성과', key:'convRate', label:'총 전환율(%)', type:'metric', sup:true},
      {cat:'전환 성과', key:'convAmt', label:'총 전환매출액', type:'metric', sup:true},
      {cat:'전환 성과', key:'convDirectAmt', label:'직접전환매출액', type:'metric', sup:true},
      {cat:'전환 성과', key:'convIndirectAmt', label:'간접전환매출액', type:'metric', sup:true},
      {cat:'전환 성과', key:'costPerConv', label:'총 전환당비용', type:'metric', sup:true},
      {cat:'전환 성과', key:'roasTotal', label:'총 광고수익률(%)', type:'metric', sup:true},
      ...
      {cat:'전환 성과', key:'byConvType', label:'전환 유형', type:'dim', sup:true},
